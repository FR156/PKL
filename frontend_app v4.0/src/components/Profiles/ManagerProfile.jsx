        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-6">
            <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                <h2 className="text-xl font-semibold text-gray-800 flex items-center">
                    <i className="fas fa-user-circle mr-3 text-[#708993]"></i> Profil Manajer
                </h2>
                ...
                <div className="lg:w-1/3 flex flex-col items-center">
                    ...
                    <div className="text-center w-full">
                        ...
                        <div className="inline-block bg-[#708993] text-white px-3 py-1 rounded-full text-sm font-medium mb-2">
                            {user.division || 'Manajemen'}
                        </div>
                        <p className="text-gray-600 text-sm mb-4 capitalize">{user.role}</p>
                        
                        <div className="space-y-3 w-full max-w-xs">
                            <div className="bg-gray-50 rounded-lg p-3 text-center">
                                <p className="text-xs text-gray-500 font-medium mb-1">ID Manager</p>
                ...
                <div className="lg:w-2/3">
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* ID Manager (non-editable) */}
                            <div>
                                <label htmlFor="nik" className="block text-sm font-medium text-gray-700 mb-2">ID Manager</label>
                                <input
                                    type="text"
                                    id="nik"
                                    name="nik"
                                    value={user.nik || user.id || 'MG001'}
                                    disabled
