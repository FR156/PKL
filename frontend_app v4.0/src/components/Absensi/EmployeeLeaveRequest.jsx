...
const EmployeeLeaveRequest = ({ user, setPendingLeave }) => {
    ...
    const [leaveHistory, setLeaveHistory] = useState([
        ...
        {
            id: 2,
            title: 'Izin Sakit Flu',
            type: 'Izin Sakit',
            startDate: '2024-02-10',
            endDate: '2024-02-10',
            days: 1,
            reason: 'Flu dan demam tinggi',
            status: 'Approved'
        },
        {
            id: 3,
            title: 'Perjalanan Dinas Pribadi',
            type: 'Cuti Tahunan',
            startDate: '2024-03-20',
            endDate: '2024-03-25',
            days: 6,
            reason: 'Perjalanan dinas pribadi ke luar kota',
            status: 'Pending'
        }
    ]);
    ...
    const handleSubmit = (e) => {
        ...
        showSwal(
            'Pengajuan Terkirim!',
            `Permintaan ${leaveType} (${daysRequested} hari) telah dikirim untuk persetujuan Manajer.`,
            'success'
        );
    };
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-6">
            <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                <h2 className="text-xl font-semibold text-gray-800 flex items-center">
                    <i className="fas fa-calendar-alt mr-3 text-[#708993]"></i> Pengajuan Cuti & Izin
                </h2>
            </div>
            ...
            <div className="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                <div className="flex justify-between items-center">
                    <div className="text-center flex-1">
                        ...
                        <p className="text-2xl font-bold text-[#708993]">{user.cutiBalance} <span className="text-sm font-normal text-gray-600">hari</span></p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-3 border border-gray-300 rounded-lg focus:border-[#708993] focus:ring-2 focus:ring-[#708993]/20 bg-white text-black"
                                placeholder="Contoh: Liburan Keluarga, Izin Sakit, dll."
                                required
                            />
                        </div>
                    </div>
